...
void Adafruit_MCP23017::begin(uint8_t addr) {
    ...
    //Wire.begin(I2C_MASTER, 0x00, I2C_PINS_18_19, I2C_PULLUP_INT, 800000, I2C_OP_MODE_DMA);
    
    //Wire.setDefaultTimeout(100000); // 200ms
  ...
  // all pull up on inputs
  
  writeRegister(MCP23017_GPPUA, 0xFF);//, 0xFF);
